-- This file was generated by SWIG and has since been extended by hand to follow
-- the C headers under '../c', which are the source of truth: every entry here
-- mirrors a declaration there.
--
with
     box2d_c.Pointers,
     box2d_c.b2d_Contact,
...
is
   ...
   function b2d_new_Object (Site         : in c_math_c.Vector_2.Pointer;
                            ...
                            is_Kinematic : in interfaces.C.int) return box2d_c.Pointers.Object_pointer;
   ...
   procedure b2d_Object_Restitution_is (Self : in box2d_c.Pointers.Object_pointer;
                                        Now  : in c_math_c.Real);
   function  b2d_Object_is_Active      (Self : in box2d_c.Pointers.Object_pointer) return interfaces.C.int;
   procedure b2d_Object_activate       (Self : in box2d_c.Pointers.Object_pointer);
   ...
   procedure b2d_free_Joint       (Self : in box2d_c.Pointers.Joint_pointer);
   ...
   function b2d_Joint_Frame_A_is (Self : in box2d_c.Pointers.Joint_pointer;
                                  Now  : in c_math_c.Matrix_4x4.Pointer) return interfaces.C.int;

   function b2d_Joint_Frame_B_is (Self : in box2d_c.Pointers.Joint_pointer;
                                  Now  : in c_math_c.Matrix_4x4.Pointer) return interfaces.C.int;
   ...
   function b2d_Joint_Velocity_is (Self : in box2d_c.Pointers.Joint_pointer;
                                   DoF  : in interfaces.C.int;
                                   Now  : in c_math_c.Real) return interfaces.C.int;

   function b2d_Joint_lower_Limit (Self : in box2d_c.Pointers.Joint_pointer;
                                   DoF  : in interfaces.C.int) return c_math_c.Real;
   function b2d_Joint_upper_Limit (Self : in box2d_c.Pointers.Joint_pointer;
                                   DoF  : in interfaces.C.int) return c_math_c.Real;
   function b2d_Joint_lower_Limit_is (Self : in box2d_c.Pointers.Joint_pointer;
                                      DoF  : in interfaces.C.int;
                                      Now  : in c_math_c.Real) return interfaces.C.int;
   function b2d_Joint_upper_Limit_is (Self : in box2d_c.Pointers.Joint_pointer;
                                      DoF  : in interfaces.C.int;
                                      Now  : in c_math_c.Real) return interfaces.C.int;
   ...
   function b2d_Joint_collide_Connected (Self : in box2d_c.Pointers.Joint_pointer) return swig.bool;

   function b2d_Joint_hinge_limit_Enabled (Self : in box2d_c.Pointers.Joint_pointer) return swig.bool;

   procedure b2d_Joint_hinge_Limits_are (Self : in box2d_c.Pointers.Joint_pointer;
                                         Low  : in c_math_c.Real;
                                         High : in c_math_c.Real);

   function b2d_Joint_hinge_local_Anchor_on_A (Self : in box2d_c.Pointers.Joint_pointer) return c_math_c.Vector_3.Item;

   function b2d_Joint_hinge_local_Anchor_on_B (Self : in box2d_c.Pointers.Joint_pointer) return c_math_c.Vector_3.Item;

   function b2d_Joint_hinge_reference_Angle (Self : in box2d_c.Pointers.Joint_pointer) return c_math_c.Real;

   function b2d_Joint_hinge_Angle (Self : in box2d_c.Pointers.Joint_pointer) return c_math_c.Real;

   function b2d_Joint_hinge_motor_Enabled (Self : in box2d_c.Pointers.Joint_pointer) return swig.bool;

   function b2d_Joint_hinge_motor_Speed (Self : in box2d_c.Pointers.Joint_pointer) return c_math_c.Real;
   ...
   function  b2d_Space_Gravity    (Self : in box2d_c.Pointers.Space_pointer) return c_math_c.Vector_3.Item;
...
private
   ...
   pragma import (C, b2d_new_Object,                         "b2d_new_Object");
   ...
   pragma import (C, b2d_Object_is_Active,                   "b2d_Object_is_Active");
   pragma import (C, b2d_Object_activate,                    "b2d_Object_activate");
   ...
   pragma import (C, b2d_free_Joint,                         "b2d_free_Joint");
   ...
   pragma import (C, b2d_Joint_user_Data_is,                 "b2d_Joint_user_Data_is");
   ...
   pragma import (C, b2d_Joint_Frame_A_is,                   "b2d_Joint_Frame_A_is");
   pragma import (C, b2d_Joint_Frame_B_is,                   "b2d_Joint_Frame_B_is");
   ...
   pragma import (C, b2d_Joint_Extent,                       "b2d_Joint_Extent");
   pragma import (C, b2d_Joint_Velocity_is,                  "b2d_Joint_Velocity_is");
   pragma import (C, b2d_Joint_lower_Limit,                  "b2d_Joint_lower_Limit");
   pragma import (C, b2d_Joint_upper_Limit,                  "b2d_Joint_upper_Limit");
   pragma import (C, b2d_Joint_lower_Limit_is,               "b2d_Joint_lower_Limit_is");
   pragma import (C, b2d_Joint_upper_Limit_is,               "b2d_Joint_upper_Limit_is");
   ...
   pragma import (C, b2d_Joint_collide_Connected,            "Ada_b2d_Joint_collide_Connected");
   pragma import (C, b2d_Joint_hinge_limit_Enabled,          "Ada_b2d_Joint_hinge_limit_Enabled");
   pragma import (C, b2d_Joint_hinge_Limits_are,             "Ada_b2d_Joint_hinge_Limits_are");
   pragma import (C, b2d_Joint_hinge_local_Anchor_on_A,      "Ada_b2d_Joint_hinge_local_Anchor_on_A");
   pragma import (C, b2d_Joint_hinge_local_Anchor_on_B,      "Ada_b2d_Joint_hinge_local_Anchor_on_B");
   pragma import (C, b2d_Joint_hinge_reference_Angle,        "Ada_b2d_Joint_hinge_reference_Angle");
   ...
   pragma import (C, b2d_Space_Gravity,                      "b2d_Space_Gravity");
