...
extern "C"
{
  ...
  struct Object*       b3d_new_Object            (Real     Mass,
						  Shape*   the_Shape,
						  int      is_Kinematic);
  void                 b3d_free_Object           (Object*   Self);
  ...
  void                 b3d_Object_Scale_is       (Object*   Self,   Vector_3*   Now);

  int                  b3d_Object_is_Active      (Object*   Self);
  void                 b3d_Object_activate       (Object*   Self,   int   force_Activation);
