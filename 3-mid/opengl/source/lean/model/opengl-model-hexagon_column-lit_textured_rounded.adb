      ...
      declare
         ...
         the_Vertices : constant Geometry.lit_textured.Vertex_array
           := [ 1 => (Site => upper_Sites (1),   Normal => shaft_Normals (1),   Coords => (0.0, 1.0),   Shine => default_Shine),
                ...
                3 => (Site => upper_Sites (2),   Normal => shaft_Normals (2),   Coords => (0.2, 1.0),   Shine => default_Shine),
                4 => (Site => lower_Sites (2),   Normal => shaft_Normals (2),   Coords => (0.2, 0.0),   Shine => default_Shine),
                5 => (Site => upper_Sites (3),   Normal => shaft_Normals (3),   Coords => (0.4, 1.0),   Shine => default_Shine),
                6 => (Site => lower_Sites (3),   Normal => shaft_Normals (3),   Coords => (0.4, 0.0),   Shine => default_Shine),
                7 => (Site => upper_Sites (4),   Normal => shaft_Normals (4),   Coords => (0.6, 1.0),   Shine => default_Shine),
                8 => (Site => lower_Sites (4),   Normal => shaft_Normals (4),   Coords => (0.6, 0.0),   Shine => default_Shine),
                9 => (Site => upper_Sites (5),   Normal => shaft_Normals (5),   Coords => (0.8, 1.0),   Shine => default_Shine),
               10 => (Site => lower_Sites (5),   Normal => shaft_Normals (5),   Coords => (0.8, 0.0),   Shine => default_Shine),
               11 => (Site => upper_Sites (6),   Normal => shaft_Normals (6),   Coords => (1.0, 1.0),   Shine => default_Shine),
               12 => (Site => lower_Sites (6),   Normal => shaft_Normals (6),   Coords => (1.0, 0.0),   Shine => default_Shine)];
      begin
