...
is
   ...
   begin
      ...
      --
      vertex_Shader  .define (Shader.Vertex,   API.shader_Folder & "lit_colored_textured_skinned.vert");
      fragment_Shader.define (Shader.Fragment, (asset_Names' (1 => to_Asset (API.shader_Folder & "version.header"),
                                                              ...
                                                              3 => to_Asset (API.shader_Folder & "texturing-frag.snippet"),
                                                              4 => to_Asset (API.shader_Folder & "lit_colored_textured.frag"))));
      -- fragment_Shader.define (Shader.Fragment, API.shader_Folder & "lit_colored_textured_skinned.frag");
